...
void test_fsm_start_blocks_until_dc_link_discharged(void);
void test_discharge_hold_keeps_sdc_open_while_link_charged(void);
void test_fsm_start_blocks_on_stale_dc_bus(void);
void test_fsm_charger_arms_regardless_of_dc_link(void);
...
RUN_TEST(test_bms_ltc_clean_response_decodes_all_cells);
    ...
    RUN_TEST(test_fsm_start_blocks_until_dc_link_discharged);
    RUN_TEST(test_discharge_hold_keeps_sdc_open_while_link_charged);
    RUN_TEST(test_fsm_start_blocks_on_stale_dc_bus);
    RUN_TEST(test_fsm_charger_arms_regardless_of_dc_link);
