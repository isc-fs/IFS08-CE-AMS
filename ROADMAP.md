...
| 5 | State machine + integration | 🔄 active `feat/14-state-task` · 🔜 planned `feat/15-precharge-timing` · 🔜 planned `feat/16-fan-telemetry` · 🔜 planned `feat/17-sil-tests` · 🔜 planned `feat/18-commissioning` | `v1.0.0` |
