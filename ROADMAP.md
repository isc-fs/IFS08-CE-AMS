...
| 5 | State machine + integration | ✅ done `feat/14-state-task` · ✅ done `feat/15-precharge-timing` · 🔄 active `feat/16-fan-telemetry` · ✅ done `feat/17-sil-tests` · ✅ done `feat/18-commissioning` | `v1.0.0` |
