...
| `BalanceMaxActive` | 8 | cells/module | Max simultaneous dischargers per module. 47R\|\|47R = 23.5R per cell → 0.75 W/cell @4.2 V, so 8 = 6.0 W per module / 30 W pack. Resistors (2512, **2 W**) run ~19 % — comfortable. The limit is heat out of the box, which the rating does not change. **Measure board temperature at this setting.** | | ☐ |
