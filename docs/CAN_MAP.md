...
| `0x6C7` | 1 per-IC PEC count A | `[0..7]` saturating u8 per IC for chain index 0..7 (0xFF = ≥ 255 failures since boot) | 1 Hz |
| `0x6C8` | 1 per-IC PEC count B | `[0..1]` saturating u8 per IC for chain index 8..9, `[2..7]` reserved (0) | 1 Hz |
